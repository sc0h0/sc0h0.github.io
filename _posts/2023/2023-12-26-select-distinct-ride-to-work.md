...
In total there were around 200 routes analysed for similarity. This means the DTW distance must be calculated for approximately 19,900 (200ⁿC₂ = 200! / (2! × (200-2)!)) unique pairs of routes.
