...
The challenge is that the format naturally compresses everyone into the same set of signals, which makes it difficult to distinguish between those who are actively building and applying their skills and those who simply describe them well.
...
Rather than waiting for applications, you start from public work and work backwards to the person behind it.

This shows people in a more natural state of work. Not a polished profile, but how they actually write queries, structure scripts, and organise their work.
...
This is a small proof-of-concept pipeline that pulls public GitHub activity, extracts real code, and uses an LLM to assess and objectively classify a person’s technical and analytical strengths.
